...
class SimpleChat(WebSocket):
    ...
    def handleMessage(self):
        ...
        p1 = subprocess.Popen(['python', project_path + '/bot/combot/conversation_server.py'],
                              creationflags=CREATE_NEW_CONSOLE)
        p2 = subprocess.Popen(['python', project_path + '/bot/SimpleWebSocketServer/SimpleExampleServer.py'],
                              creationflags=CREATE_NEW_CONSOLE)
